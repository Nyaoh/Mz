...
/**
 * Element Text and hidden.
 *
 * @author ehangard
 */
class Klee_Plugin_Element_TextAndHidden extends Zend_Form_Element_Text
{
	/**
	...
	public $helper = 'formTextAndHidden';
	
	/*
	 * (non-PHPdoc)
	 * @see Zend_Form_Element::getLabel()
	 */
